            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="DropDownPersonType"  
                                    ...
                                    Itemtype="Krypto.Models.Client" 
                                    DataTextField="NameClient" 
                                    DataValueField="IdClient"
                                    SelectMethod="GetUser" OnSelectedIndexChanged="DropDownPersonType_SelectedIndexChanged" OnDataBound="DropDownPersonType_DataBound">
                    </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <asp:DropDownList ID="DropDownDocumentType"  
                                    ...
                                    DataValueField="IdClient"
                                    SelectMethod="GetUser" OnSelectedIndexChanged="DropDownDocumentType_SelectedIndexChanged" OnDataBound="DropDownDocumentType_DataBound">
                    </asp:DropDownList>
                    </div>
                </div>
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-2">
                        <asp:Button ID="btnAddClient" runat="server" CssClass="btn btn-danger form-control" Text="Agregar Cliente" OnClick="AddClientButton_Click"
